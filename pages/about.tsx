...
/**
 *
 * @returns About page. Does not require login
 */
    ...
    <div>
      ...
      <Layout>
        ...
        <article className="container text-center mt-5">
          ...
          <p className="fs-4">
            We aim to be your go-to partner for piping material takeoffs. We
            plan to do this by providing quality and efficient service for every
            isometric package submitted to our program. We will generate value
            for our clients by providing time and cost savings.
          </p>
        </article>
        <article className="container text-center mt-5">
          <header>
          ...
          <section className="row mt-3">
            <article className="col-12 col-md-4">
              ...
              <p className="fs-5">
                ...
                satisfied with our services. Our goal is to provide an
                effortless and valuable service to our clients.
              </p>
            </article>
            <article className="col-12 col-md-4">
              ...
              <p className="fs-5">
                ...
                offerings as well as the creation of additional services. We
                will always strive to improve our performance.
              </p>
            </article>
            <article className="col-12 col-md-4">
